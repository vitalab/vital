...
class EchoMeasure(Measure):
    ...
    def _endo_base(
        ...
        endo_labels: SemanticStructureId = Label.ENDO.value,
        epi_labels: SemanticStructureId = Label.EPI.value,
        ...
        Args:
            ...
            endo_labels: Labels of the classes that are part of the left ventricle.
            epi_labels: Labels of the classes that are part of the myocardium.

        Returns:
            Coordinates of the left and right markers at the base of the left ventricle, or NaNs if the landmarks
            cannot be reliably estimated.
        """
        left_ventricle = np.isin(segmentation, endo_labels)
        myocardium = np.isin(segmentation, epi_labels)
    ...
    def endo_base_width(
        ...
        Args:
            ...
            endo_labels: Labels of the classes that are part of the left ventricle.
            epi_labels: Labels of the classes that are part of the myocardium. The location of the myocardium is
        ...
        """
        lv_base_coords = EchoMeasure._endo_base(segmentation, endo_labels=endo_labels, epi_labels=epi_labels)
        return (
